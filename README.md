...
This theme includes six distinct variants:
...
- **Adaptify Light** - A clean light theme with vibrant syntax colors
- **Adaptify Light (Blurred)** - Light theme with translucent backgrounds
